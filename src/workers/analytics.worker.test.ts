...
describe('Analytics Web Worker Logic', () => {
    ...
    it('correctly calculates stats for a sample dataset', () => {
        const mockData: RawEventData[] = [
            { id: '1', category: 'Tech', revenue: 1000, attendees: 50, durationMinutes: 120, date: '2026-01-01' },
            { id: '2', category: 'Tech', revenue: 2000, attendees: 100, durationMinutes: 180, date: '2026-01-02' },
            { id: '3', category: 'Arts', revenue: 500, attendees: 30, durationMinutes: 60, date: '2026-01-03' },
        ];
